...
(function(f) {
    ...
    p(s.lang, {printChart: "打印该图表", downloadPNG: "下载 PNG 格式图表", downloadJPEG: "下载 JEPG 格式图表", downloadPDF: "下载 PDF 图表文件", downloadSVG: "下载 SVG 格式图表", contextButtonTitle: "下载该图表"});
    s.navigation = {
        menuStyle: {border: "1px solid #ccc",
            background: "#FFFFFF", padding: "0"}, 
        menuItemStyle: {padding: "5px 10px", background: "none", color: "#333", fontSize: E ? "14px" : "11px"}, 
        menuItemHoverStyle: {background: "#41c4dd", color: "#FFFFFF"}, 
        buttonOptions: {
            symbolFill: "#E0E0E0", 
            symbolSize: 14, 
            symbolStroke: "#fff", 
            ...
            buttonSpacing: 3, 
            height: 22, 
            theme: {fill: "#41c4dd", stroke: "#41c4dd"}, 
            verticalAlign: "top", 
            width: 24}
    };
    ...
    p(A.prototype, {getSVG: function(b) {
            ...
            if (!i)
                e[j] = i = l("div", {className: b}, {position: "absolute", zIndex: 1E3, padding: u + "px"}, e.container), w = l("div", null, p({MozBoxShadow: "0 2px 6px rgba(0, 0, 0, .2)",
                    WebkitBoxShadow: "0 2px 6px rgba(0, 0, 0, .2)", boxShadow: "0 2px 6px rgba(0, 0, 0, .2)"}, k.menuStyle), i), x = function() {
                    v(i, {display: "none"});
                    g && g.setState(0);
                    e.openMenu = !1
