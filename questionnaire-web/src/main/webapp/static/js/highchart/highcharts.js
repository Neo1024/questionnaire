...
(function() {
    ...
    ta.prototype = {Element: S, init: function(a, b, c, d, e) {
            ...
            m = e.style;
            delete e.style;
            f = w(e, {stroke: "#f18c2a", // Modified color style (by CiCi)
                fill: "#f18c2a"}, f);
            o = f.style;
            delete f.style;
            g = w(e, {stroke: "#f18c2a", // Modified color style (by CiCi)
                fill: "#f18c2a"}, g);
            p = g.style;
            delete g.style;
            ...
            return j.on("click", function() {
                k !== 3 && d.call(j)
            }).attr(e).css(r({cursor: "pointer"}, m)) // Modified cursor style (by CiCi)
